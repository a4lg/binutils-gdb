...
static struct riscv_implicit_subset riscv_implicit_subsets[] =
{
  ...
  {"smsdia", "zicsr",		check_implicit_always},
  ...
  {"svpams", "zicsr",		check_implicit_always},
  {NULL, NULL, NULL}
};
...
static struct riscv_supported_ext riscv_supported_std_s_ext[] =
{
  ...
  {"smmtt",		ISA_SPEC_CLASS_DRAFT,		0, 1, 0 },
  {"smsdia",		ISA_SPEC_CLASS_DRAFT,		0, 1, 0 },
  {"smsdid",		ISA_SPEC_CLASS_DRAFT,		0, 1, 0 },
  ...
  {"svpams",		ISA_SPEC_CLASS_DRAFT,		0, 1, 0 },
