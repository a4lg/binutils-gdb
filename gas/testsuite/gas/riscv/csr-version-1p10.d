...
[ 	]+[0-9a-f]+:[ 	]+3c002573[ 	]+csrr[ 	]+a0,mmte
[ 	]+[0-9a-f]+:[ 	]+3c059073[ 	]+csrw[ 	]+mmte,a1
[ 	]+[0-9a-f]+:[ 	]+3c102573[ 	]+csrr[ 	]+a0,mpmmask
[ 	]+[0-9a-f]+:[ 	]+3c159073[ 	]+csrw[ 	]+mpmmask,a1
[ 	]+[0-9a-f]+:[ 	]+3c202573[ 	]+csrr[ 	]+a0,mpmbase
[ 	]+[0-9a-f]+:[ 	]+3c259073[ 	]+csrw[ 	]+mpmbase,a1
...
[ 	]+[0-9a-f]+:[ 	]+3c202573[ 	]+csrr[ 	]+a0,mpmbase
[ 	]+[0-9a-f]+:[ 	]+3c259073[ 	]+csrw[ 	]+mpmbase,a1
[ 	]+[0-9a-f]+:[ 	]+1c002573[ 	]+csrr[ 	]+a0,smte
[ 	]+[0-9a-f]+:[ 	]+1c059073[ 	]+csrw[ 	]+smte,a1
[ 	]+[0-9a-f]+:[ 	]+1c102573[ 	]+csrr[ 	]+a0,spmmask
[ 	]+[0-9a-f]+:[ 	]+1c159073[ 	]+csrw[ 	]+spmmask,a1
[ 	]+[0-9a-f]+:[ 	]+1c202573[ 	]+csrr[ 	]+a0,spmbase
[ 	]+[0-9a-f]+:[ 	]+1c259073[ 	]+csrw[ 	]+spmbase,a1
[ 	]+[0-9a-f]+:[ 	]+4c002573[ 	]+csrr[ 	]+a0,umte
[ 	]+[0-9a-f]+:[ 	]+4c059073[ 	]+csrw[ 	]+umte,a1
[ 	]+[0-9a-f]+:[ 	]+4c102573[ 	]+csrr[ 	]+a0,upmmask
[ 	]+[0-9a-f]+:[ 	]+4c159073[ 	]+csrw[ 	]+upmmask,a1
[ 	]+[0-9a-f]+:[ 	]+4c202573[ 	]+csrr[ 	]+a0,upmbase
[ 	]+[0-9a-f]+:[ 	]+4c259073[ 	]+csrw[ 	]+upmbase,a1
[ 	]+[0-9a-f]+:[ 	]+2c002573[ 	]+csrr[ 	]+a0,vsmte
[ 	]+[0-9a-f]+:[ 	]+2c059073[ 	]+csrw[ 	]+vsmte,a1
[ 	]+[0-9a-f]+:[ 	]+2c102573[ 	]+csrr[ 	]+a0,vspmmask
[ 	]+[0-9a-f]+:[ 	]+2c159073[ 	]+csrw[ 	]+vspmmask,a1
[ 	]+[0-9a-f]+:[ 	]+2c202573[ 	]+csrr[ 	]+a0,vspmbase
[ 	]+[0-9a-f]+:[ 	]+2c259073[ 	]+csrw[ 	]+vspmbase,a1
