...
/* Zjpm extension CSRs (both privileged and unprivileged).  */
DECLARE_CSR(smte, CSR_SMTE, CSR_CLASS_ZJPM, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(spmmask, CSR_SPMMASK, CSR_CLASS_ZJPM, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(spmbase, CSR_SPMBASE, CSR_CLASS_ZJPM, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(umte, CSR_UMTE, CSR_CLASS_ZJPM, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(upmmask, CSR_UPMMASK, CSR_CLASS_ZJPM, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(upmbase, CSR_UPMBASE, CSR_CLASS_ZJPM, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(vsmte, CSR_VSMTE, CSR_CLASS_ZJPM_AND_H, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(vspmmask, CSR_VSPMMASK, CSR_CLASS_ZJPM_AND_H, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(vspmbase, CSR_VSPMBASE, CSR_CLASS_ZJPM_AND_H, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
#endif /* DECLARE_CSR */
...
/* Zjpm extension CSRs (currently conflicting with pmpaddr16..18).  */
DECLARE_CSR_ALIAS(mmte, CSR_MMTE, CSR_CLASS_ZJPM, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR_ALIAS(mpmmask, CSR_MPMMASK, CSR_CLASS_ZJPM, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR_ALIAS(mpmbase, CSR_MPMBASE, CSR_CLASS_ZJPM, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
