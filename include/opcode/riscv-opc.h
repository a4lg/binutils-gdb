...
/* Smsdia extension.  */
#define CSR_MSDEIA 0xbc1 /* TENTATIVELY use custom CSR address.  */
#define CSR_MSDEIE 0xbc2 /* TENTATIVELY use custom CSR address.  */
/* Smsdid extension.  */
#define CSR_MTTP 0xbc0   /* TENTATIVELY use custom CSR address.  */
/* Smstateen extension */
...
/* Smsdia extension.  */
DECLARE_CSR(msdeia, CSR_MSDEIA, CSR_CLASS_SMSDIA, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
DECLARE_CSR(msdeie, CSR_MSDEIE, CSR_CLASS_SMSDIA, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
/* Smsdid extension.  */
DECLARE_CSR(mttp, CSR_MTTP, CSR_CLASS_SMSDID, PRIV_SPEC_CLASS_NONE, PRIV_SPEC_CLASS_NONE)
