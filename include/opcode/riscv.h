...
enum riscv_insn_class
{
  ...
  INSN_CLASS_ZAWRS,
  INSN_CLASS_F_INX,
  INSN_CLASS_D_INX,  /* Diagnostics only.  */
  INSN_CLASS_Q_INX,  /* Diagnostics only.  */
  INSN_CLASS_ZDINX,
  INSN_CLASS_ZQINX,
  INSN_CLASS_ZFH_INX,
  INSN_CLASS_ZFHMIN,
  INSN_CLASS_ZFHMIN_INX,
  INSN_CLASS_ZFHMIN_AND_D_INX,  /* Diagnostics only.  */
  INSN_CLASS_ZFHMIN_AND_Q_INX,  /* Diagnostics only.  */
  INSN_CLASS_ZFHMIN_AND_D,
  INSN_CLASS_ZFHMIN_AND_Q,
  INSN_CLASS_ZHINXMIN_AND_ZDINX,
  INSN_CLASS_ZHINXMIN_AND_ZQINX,
  INSN_CLASS_ZBA,
  INSN_CLASS_ZBB,
  INSN_CLASS_ZBC,
  INSN_CLASS_ZBS,
